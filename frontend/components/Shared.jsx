...
const Shared = () => {
  ...
  const getSharedFiles = async () => {
    try {
      const res = await fetch(`${url}file/shared-with-me`, {
        method: "GET",
        credentials: "include"
      });
  ...
  return (
    <div className="w-full h-full flex flex-col gap-4 overflow-hidden bg-transparent animate-fade-in">
      {/* Files Section */}
